...
# Dataset url => csv file in working directory (documents) set for te environment
...
```{r}
# Checking no of  missing entries of all the variables
...
###Observation 1: childrens column has 4 missing values 
###Observation 2; No missing values in all remaining variables 
...
```{r}
# Checking if all of the columns are all null or have NA/missing values 
# ---
...
# We observe the following from our dataset: 
#   
#   Observation 1: all of the columns in the dataset are not having missing values 
# 
# ```{r}
```{r}
# Checking if any of the rows are all null
#
all(is.na(hotel_df)) == nrow(hotel_df)
```

# 
# We observe the following from our dataset:
#   
#Observation 1: Not all rows have NA / missing values 
#Observation 2
# 
# {r}
